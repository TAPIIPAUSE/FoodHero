...
class WasteBarchart extends StatefulWidget {
  const WasteBarchart({super.key});

  @override
  State<WasteBarchart> createState() => _WasteBarchartState();
}

class _WasteBarchartState extends State<WasteBarchart> {
  int touchedIndex = -1;
