...
const foodInventorySchema = new mongoose.Schema({
    ...
    current_quantity: {type: mongoose.Schema.Types.Decimal128, required: true},
    total_quanitity: {type: mongoose.Schema.Types.Decimal128, required: true},
    consumed_quantity: {type: mongoose.Schema.Types.Decimal128, required: true, default: 0.0},
